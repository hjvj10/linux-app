...
from ...scheduler.eventloop import AsyncIOScheduler
...
class Observable(typing.Observable):
    ...
    def __add__(self, other) -> 'Observable':
        """Pythonic version of :func:`concat <...concat>`.
    ...
    def __iadd__(self, other) -> 'Observable':
        """Pythonic use of :func:`concat <...concat>`.
    ...
    def __getitem__(self, key) -> 'Observable':
        """
        Pythonic version of :func:`slice <...operators.slice>`.
