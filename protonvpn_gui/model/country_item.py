from protonvpn_nm_lib import ServerFilter
...
class CountryItem:
    ...
    """
    def __init__(self, server_item=ServerItem, server_filter=ServerFilter()):
        self._server_item: ServerItem = server_item
        self._server_filter: ServerFilter = server_filter
    ...
    def create_secure_core_country(
        ...
        for servername in servername_list:
            logical_server = self._server_filter.get_server_by_name(
                server_list.servers, servername
            )
