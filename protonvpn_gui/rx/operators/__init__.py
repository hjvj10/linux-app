...
from ..internal.utils import NotSet
from ..core import Observable, ConnectableObservable, GroupedObservable, typing, pipe
from ..core.typing import Mapper, MapperIndexed, Predicate, PredicateIndexed, Comparer, Accumulator
...
def all(predicate: Predicate) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.all import _all
...
def amb(right_source: Observable) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.amb import _amb
...
def as_observable() -> Callable[[Observable], Observable]:
    ...
    Returns:
        ...
        source sequence.
    """
    from ..core.operators.asobservable import _as_observable
...
def average(key_mapper: Optional[Mapper] = None) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.average import _average
...
def buffer(boundaries: Observable) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.buffer import _buffer
...
def buffer_when(closing_mapper: Callable[[], Observable]) -> Callable[[Observable], Observable]:
    ...
    Examples:
        >>> res = buffer_when(lambda: ..timer(0.5))
    ...
    """
    from ..core.operators.buffer import _buffer_when
...
def buffer_toggle(openings: Observable,
    ...
    >>> res = buffer_toggle(..interval(0.5), lambda i: ..timer(i))
    ...
    Returns:
        ...
        observable sequence of windows.
    """
    from ..core.operators.buffer import _buffer_toggle
...
def buffer_with_count(count: int, skip: Optional[int] = None) -> Callable[[Observable], Observable]:
    ...
    Returns:
        ...
        observable sequence of buffers.
    """
    from ..core.operators.buffer import _buffer_with_count
...
def buffer_with_time(timespan: typing.RelativeTime,
    ...
    """
    from ..core.operators.bufferwithtime import _buffer_with_time
...
def buffer_with_time_or_count(timespan, count, scheduler=None) -> Callable[[Observable], Observable]:
    ...
    Returns:
        ...
        returns an observable sequence of buffers.
    """
    from ..core.operators.bufferwithtimeorcount import _buffer_with_time_or_count
...
def catch(handler: Union[Observable, Callable[[Exception, Observable], Observable]]
    ...
    Returns:
        ...
        exception occurred.
    """
    from ..core.operators.catch import _catch
...
def combine_latest(*others: Observable) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.combinelatest import _combine_latest
...
def concat(*sources: Observable) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.concat import _concat
...
def contains(value: Any,
    ...
    Returns:
        ...
        specified value.
    """
    from ..core.operators.contains import _contains
...
def count(predicate: Optional[typing.Predicate] = None) -> Callable[[Observable], Observable]:
    ...
    from ..core.operators.count import _count
...
def debounce(duetime: typing.RelativeTime,
    ...
    """
    from ..core.operators.debounce import _debounce
...
def default_if_empty(default_value: Any = None) -> Callable[[Observable], Observable]:
    ...
    Returns:
        ...
        the source.
    """
    from ..core.operators.defaultifempty import _default_if_empty
...
def delay_subscription(duetime: typing.AbsoluteOrRelativeTime,
    ...
    """
    from ..core.operators.delaysubscription import _delay_subscription
...
def delay_with_mapper(subscription_delay=None,
    ...
    Examples:
        ...
        >>> res = source.delay_with_mapper(..timer(2.0), lambda x: ..timer(x))
    ...
    Returns:
        ...
        time-shifted observable sequence.
    """
    from ..core.operators.delaywithmapper import _delay_with_mapper
...
def dematerialize() -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.dematerialize import _dematerialize
...
def delay(duetime: typing.RelativeTime,
    ...
    """
    from ..core.operators.delay import _delay
...
def distinct(key_mapper: Optional[Mapper] = None,
    ...
    Returns:
        ...
        sequence.
    """
    from ..core.operators.distinct import _distinct
...
def distinct_until_changed(key_mapper: Optional[Mapper] = None,
    ...
    Returns:
        ...
        source sequence.
    """
    from ..core.operators.distinctuntilchanged import _distinct_until_changed
...
def do(observer: typing.Observer) -> Callable[[Observable], Observable]:
    ...
    Returns:
        ...
        applied.
    """
    from ..core.operators.do import do as do_
    return do_(observer)
...
def do_action(on_next: Optional[typing.OnNext] = None,
    ...
    Returns:
        ...
        applied.
    """
    from ..core.operators.do import _do_action
...
def do_while(condition: Predicate) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.dowhile import _do_while
...
def element_at(index: int) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.elementatordefault import _element_at_or_default
...
def exclusive() -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.exclusive import _exclusive
    return _exclusive()
...
def expand(mapper: Mapper) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.expand import _expand
...
def filter(predicate: Predicate) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.filter import _filter
...
def filter_indexed(predicate_indexed: Optional[PredicateIndexed] = None) -> Callable[[Observable], Observable]:
    ...
    Returns:
        ...
        input sequence that satisfy the condition.
    """
    from ..core.operators.filter import _filter_indexed
...
def finally_action(action: Callable) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.finallyaction import _finally_action
...
def find(predicate: Predicate) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.find import _find_value
...
def first(predicate: Optional[Predicate] = None) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.first import _first
...
def first_or_default(predicate: Optional[Predicate] = None,
    ...
    """
    from ..core.operators.firstordefault import _first_or_default
...
def flat_map(mapper: Optional[Mapper] = None) -> Callable[[Observable], Observable]:
    ...
    Returns:
        ...
        the input sequence.
    """
    from ..core.operators.flatmap import _flat_map
...
def flat_map_indexed(mapper_indexed: Optional[MapperIndexed] = None) -> Callable[[Observable], Observable]:
    ...
    Returns:
        ...
        the input sequence.
    """
    from ..core.operators.flatmap import _flat_map_indexed
...
def flat_map_latest(mapper: Mapper) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.flatmap import _flat_map_latest
...
def fork_join(*others: Observable) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.forkjoin import _fork_join
...
def group_by(key_mapper: Mapper,
    ...
    """
    from ..core.operators.groupby import _group_by
...
def group_by_until(key_mapper: Mapper,
    ...
    Examples:
        >>> group_by_until(lambda x: x.id, None, lambda : ..never())
        >>> group_by_until(lambda x: x.id, lambda x: x.name, lambda grp: ..never())
        >>> group_by_until(lambda x: x.id, lambda x: x.name, lambda grp: ..never(), lambda: ReplaySubject())
    ...
    """
    from ..core.operators.groupbyuntil import _group_by_until
...
def group_join(right: Observable,
    ...
    Returns:
        ...
        duration.
    """
    from ..core.operators.groupjoin import _group_join
...
def ignore_elements() -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.ignoreelements import _ignore_elements
...
def is_empty() -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.isempty import _is_empty
    return _is_empty()
...
def join(right: Observable,
    ...
    Return:
        ...
        duration.
    """
    from ..core.operators.join import _join
...
def last(predicate: Optional[Predicate] = None) -> Callable[[Observable], Observable]:
    ...
    Returns:
        ...
        predicate.
    """
    from ..core.operators.last import _last
...
def last_or_default(predicate: Optional[Predicate] = None,
    ...
    Returns:
        ...
        predicate, or a default value if no such element exists.
    """
    from ..core.operators.lastordefault import _last_or_default
...
def map(mapper: Optional[Mapper] = None) -> Callable[[Observable], Observable]:
    ...
    Returns:
        ...
        of the source.
    """
    from ..core.operators.map import _map
    return _map(mapper)
...
def map_indexed(mapper_indexed: Optional[MapperIndexed] = None) -> Callable[[Observable], Observable]:
    ...
    Returns:
        ...
        of the source.
    """
    from ..core.operators.map import _map_indexed
...
def materialize() -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.materialize import _materialize
    return _materialize()
...
def max(comparer: Optional[Comparer] = None) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.max import _max
...
def max_by(key_mapper: Mapper,
    ...
    """
    from ..core.operators.maxby import _max_by
...
def merge(*sources: Observable,
    ...
    Returns:
        ...
        inner sequences.
    """
    from ..core.operators.merge import _merge
...
def merge_all() -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.merge import _merge_all
    return _merge_all()
...
def min(comparer: Optional[Comparer] = None) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.min import _min
...
def min_by(key_mapper: Mapper,
    ...
    """
    from ..core.operators.minby import _min_by
...
def multicast(subject: Optional[typing.Subject] = None,
    ...
    Returns:
        ...
        mapper function.
    """
    from ..core.operators.multicast import _multicast
...
def observe_on(scheduler: typing.Scheduler) -> Callable[[Observable], Observable]:
    ...
    Returns:
        ...
        specified scheduler.
    """
    from ..core.operators.observeon import _observe_on
...
def on_error_resume_next(second: Observable) -> Callable[[Observable], Observable]:
    ...
    from ..core.operators.onerrorresumenext import _on_error_resume_next
...
def pairwise() -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.pairwise import _pairwise
    return _pairwise()
...
def partition(predicate: Predicate) -> Callable[[Observable], List[Observable]]:
    ...
    """
    from ..core.operators.partition import _partition
...
def partition_indexed(predicate_indexed: PredicateIndexed) -> Callable[[Observable], List[Observable]]:
    ...
    Returns:
        ...
        returns False.
    """
    from ..core.operators.partition import _partition_indexed
...
def pluck(key: Any) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.pluck import _pluck
    return _pluck(key)
...
def pluck_attr(prop: str) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.pluck import _pluck_attr
...
def publish(mapper: Optional[Mapper] = None) -> Callable[[Observable], ConnectableObservable]:
    ...
    Returns:
        ...
        mapper function.
    """
    from ..core.operators.publish import _publish
...
def publish_value(initial_value: Any, mapper: Optional[Mapper] = None) -> Callable[[Observable], Observable]:
    ...
    Returns:
        ...
        mapper function.
    """
    from ..core.operators.publishvalue import _publish_value
...
def reduce(accumulator: Accumulator, seed: Any = NotSet) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.reduce import _reduce
...
def ref_count() -> Callable[[ConnectableObservable], Observable]:
    ...
    observable sequence.
    """
    from ..core.operators.connectable.refcount import _ref_count
    return _ref_count()
...
def repeat(repeat_count: Optional[int] = None) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.repeat import _repeat
...
def replay(mapper: Optional[Mapper] = None,
    ...
    Returns:
        ...
        mapper function.
    """
    from ..core.operators.replay import _replay
...
def retry(retry_count: Optional[int] = None) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.retry import _retry
...
def sample(sampler: Union[typing.RelativeTime, Observable],
    ...
    """
    from ..core.operators.sample import _sample
...
def scan(accumulator: Accumulator, seed: Any = NotSet) -> Callable[[Observable], Observable]:
    ...
    Returns:
        ...
        accumulated values.
    """
    from ..core.operators.scan import _scan
...
def sequence_equal(second: Observable, comparer: Optional[Comparer] = None
    ...
    Examples:
        ...
        >>> res = sequence_equal(..return_value(42))
        >>> res = sequence_equal(..return_value({ "value": 42 }), lambda x, y: x.value == y.value)
    ...
    """
    from ..core.operators.sequenceequal import _sequence_equal
...
def share() -> Callable[[Observable], Observable]:
    ...
    Returns:
        ...
        Observable.
    """
    from ..core.operators.publish import _share
    return _share()
...
def single(predicate: Optional[Predicate] = None) -> Callable[[Observable], Observable]:
    ...
    Returns:
        ...
        predicate.
    """
    from ..core.operators.single import _single
...
def single_or_default(predicate: Optional[Predicate] = None,
    ...
    Returns:
        ...
        predicate, or a default value if no such element exists.
    """
    from ..core.operators.singleordefault import _single_or_default
...
def single_or_default_async(has_default: bool = False,
    ...
    from ..core.operators.singleordefault import _single_or_default_async
...
def skip(count: int) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.skip import _skip
    return _skip(count)
...
def skip_last(count: int) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.skiplast import _skip_last
...
def skip_last_with_time(duration: typing.RelativeTime, scheduler: typing.Scheduler = None
    ...
    """
    from ..core.operators.skiplastwithtime import _skip_last_with_time
...
def skip_until(other: Observable) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.skipuntil import _skip_until
...
def skip_until_with_time(start_time: typing.AbsoluteOrRelativeTime,
    ...
    """
    from ..core.operators.skipuntilwithtime import _skip_until_with_time
...
def skip_while(predicate: typing.Predicate) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.skipwhile import _skip_while
...
def skip_while_indexed(predicate: typing.PredicateIndexed) -> Callable[[Observable], Observable]:
    ...
    Returns:
        ...
        series that does not pass the test specified by predicate.
    """
    from ..core.operators.skipwhile import _skip_while_indexed
...
def skip_with_time(duration: typing.RelativeTime, scheduler: Optional[typing.Scheduler] = None
    ...
    """
    from ..core.operators.skipwithtime import _skip_with_time
...
def slice(start: Optional[int] = None,
    ...
    :func:`skip <..operators.skip>`,
    :func:`skip_last <..operators.skip_last>`,
    :func:`take <..operators.take>`,
    :func:`take_last <..operators.take_last>` and
    :func:`filter <..operators.filter>`.
    ...
    """
    from ..core.operators.slice import _slice
...
def some(predicate: Optional[Predicate] = None) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.some import _some
...
def start_with(*args: Any) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.startswith import _start_with
...
def subscribe_on(scheduler: typing.Scheduler) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.subscribeon import _subscribe_on
...
def sum(key_mapper: Optional[Mapper] = None) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.sum import _sum
...
def switch_latest() -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.switchlatest import _switch_latest
...
def take(count: int) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.take import _take
    return _take(count)
...
def take_last(count: int) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.takelast import _take_last
...
def take_last_buffer(count: int) -> Callable[[Observable], Observable]:
    ...
    Returns:
        ...
        sequence.
    """
    from ..core.operators.takelastbuffer import _take_last_buffer
...
def take_last_with_time(duration: typing.RelativeTime,
    ...
    Returns:
        ...
        sequence.
    """
    from ..core.operators.takelastwithtime import _take_last_with_time
...
def take_until(other: Observable) -> Callable[[Observable], Observable]:
    ...
    Returns:
        ...
        further propagation.
    """
    from ..core.operators.takeuntil import _take_until
...
def take_until_with_time(end_time: typing.AbsoluteOrRelativeTime,
    ...
    """
    from ..core.operators.takeuntilwithtime import _take_until_with_time
...
def take_while(predicate: Predicate, inclusive: bool = False) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.takewhile import _take_while
...
def take_while_indexed(predicate: PredicateIndexed, inclusive: bool = False) -> Callable[[Observable], Observable]:
    ...
    Returns:
        ...
        longer passes.
    """
    from ..core.operators.takewhile import _take_while_indexed
...
def take_with_time(duration: typing.RelativeTime, scheduler: Optional[typing.Scheduler] = None
    ...
    Returns:
        ...
        the specified duration from the start of the source sequence.
    """
    from ..core.operators.takewithtime import _take_with_time
...
def throttle_first(window_duration: typing.RelativeTime,
    ...
    """
    from ..core.operators.throttlefirst import _throttle_first
...
def throttle_with_mapper(throttle_duration_mapper: Callable[[Any], Observable]) -> Callable[[Observable], Observable]:
    ...
    Example:
        >>> op = throttle_with_mapper(lambda x: ..Scheduler.timer(x+x))
    ...
    """
    from ..core.operators.debounce import _throttle_with_mapper
...
def timestamp(scheduler: Optional[typing.Scheduler] = None) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.timestamp import _timestamp
...
def timeout(duetime: typing.AbsoluteTime,
    ...
    Returns:
        ...
        case of a timeout.
    """
    from ..core.operators.timeout import _timeout
...
def timeout_with_mapper(first_timeout: Optional[Observable] = None,
    ...
    Examples:
        >>> res = timeout_with_mapper(..timer(0.5))
        >>> res = timeout_with_mapper(..timer(0.5), lambda x: ..timer(0.2))
        >>> res = timeout_with_mapper(..timer(0.5), lambda x: ..timer(0.2)), ..return_value(42))
    ...
    Args:
        ...
        other: [Optional] Sequence to return in case of a timeout. If
            not provided, this is set to ..throw().
    ...
    Returns:
        ...
        case of a timeout.
    """
    from ..core.operators.timeoutwithmapper import _timeout_with_mapper
...
def time_interval(scheduler: Optional[typing.Scheduler] = None) -> Callable[[Observable], Observable]:
    ...
    Return:
        ...
        on values.
    """
    from ..core.operators.timeinterval import _time_interval
...
def to_dict(key_mapper: Mapper, element_mapper: Optional[Mapper] = None
    ...
    """
    from ..core.operators.todict import _to_dict
...
def to_future(future_ctor: Optional[Callable[[], Future]] = None) -> Callable[[Observable], Future]:
    ...
    """
    from ..core.operators.tofuture import _to_future
...
def to_iterable() -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.toiterable import _to_iterable
    return _to_iterable()
...
def to_marbles(timespan: typing.RelativeTime = 0.1,
    ...
    Returns:
        Observable stream.
    """
    from ..core.operators.tomarbles import _to_marbles
...
def to_set() -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.toset import _to_set
    return _to_set()
...
def while_do(condition: Predicate) -> Callable[[Observable], Observable]:
    ...
    Returns:
        ...
        condition holds.
    """
    from ..core.operators.whiledo import _while_do
...
def window(boundaries: Observable) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.window import _window
...
def window_when(closing_mapper: Callable[[], Observable]) -> Callable[[Observable], Observable]:
    ...
    Returns:
        ...
        returns an observable sequence of windows.
    """
    from ..core.operators.window import _window_when
...
def window_toggle(openings: Observable,
    ...
    >>> res = window(..interval(0.5), lambda i: ..timer(i))
    ...
    Returns:
        ...
        returns an observable sequence of windows.
    """
    from ..core.operators.window import _window_toggle
...
def window_with_count(count: int, skip: Optional[int] = None) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.windowwithcount import _window_with_count
...
def window_with_time(timespan: typing.RelativeTime,
    ...
    from ..core.operators.windowwithtime import _window_with_time
...
def window_with_time_or_count(timespan: typing.RelativeTime, count: int,
    ...
    from ..core.operators.windowwithtimeorcount import _window_with_time_or_count
...
def with_latest_from(*sources: Observable) -> Callable[[Observable], Observable]:
    ...
    Returns:
        ...
        combining elements of the sources into a tuple.
    """
    from ..core.operators.withlatestfrom import _with_latest_from
...
def zip(*args: Observable) -> Callable[[Observable], Observable]:
    ...
    """
    from ..core.operators.zip import _zip
    return _zip(*args)
...
def zip_with_iterable(second: Iterable) -> Callable[[Observable], Observable]:
    ...
    Returns:
        ...
        combining elements of the sources as a tuple.
    """
    from ..core.operators.zip import _zip_with_iterable
