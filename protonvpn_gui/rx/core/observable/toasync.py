...
from ...subject import AsyncSubject
...
def _to_async(func: Callable,
    ...
    Examples:
        res = ...to_async(lambda x, y: x + y)(4, 3)
        res = ...to_async(lambda x, y: x + y, Scheduler.timeout)(4, 3)
        res = ...to_async(lambda x: log.debug(x), Scheduler.timeout)('hello')
